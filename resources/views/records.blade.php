                ...
                <table id="records" class="table table-striped table-bordered">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td class='text-center'><a target="_blank" href="{{ env('AWS_URL') . 'processed/' . $liveImage['imageName'] . '.jpg' }}"><img width="200" class="img-fluid" src="{{ env('AWS_URL') . 'processed/' . $liveImage['imageName'] . '.jpg' }}" /></a></td>
                          @else
